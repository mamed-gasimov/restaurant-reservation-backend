...
export { default as userAccessTokenController } from './auth/accessToken.controller';
export { default as getCurrentUserController } from './auth/currentUser.controller';

export { default as getRestaurantsController } from './restaurants/getRestaurants.controller';
...
export { default as getReservationsController } from './reservations/getReservations.controller';
